...
Pulled the mold apart an hour later so that it can finish setting with both sides exposed to the air.

{% include image.html url="/assets/img/toys/shell_open.jpg" description="Plaster shell removed" %}
